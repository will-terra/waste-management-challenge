...
export const filterSlice = createAppSlice({
  ...
  reducers: (create) => ({
    handleBooleanFilter: create.reducer(
      (
        state,
        action: PayloadAction<{
          property: keyof FilterSliceState["boolean"];
          value: boolean | null;
        }>,
      ) => {
    ...
    handleNumericFilter: create.reducer(
      (
        state,
        action: PayloadAction<{
          property: keyof FilterSliceState["numeric"];
          value: number | null;
        }>,
      ) => {
    ...
    handleRangeFilter: create.reducer(
      (
        state,
        action: PayloadAction<{
          property: keyof FilterSliceState["range"];
