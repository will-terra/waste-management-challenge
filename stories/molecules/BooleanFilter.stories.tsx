...
const meta: Meta<typeof BooleanFilter> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A filter that allows the user to select between two options and returns a boolean value.",
      },
    },
    backgrounds: {
      default: "dark",
  ...
  render: (args) => (
    <div className="bg-secondaryDarkGray p-4 rounded-md">
      <BooleanFilter {...args}>
        <RadioItem
          value={true}
          checked={args.selectedValue === true}
          label="Yes"
        />
        <RadioItem
          value={false}
          checked={args.selectedValue === false}
          label="No"
        />
